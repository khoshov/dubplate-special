...
def test_update_audio_from_youtube_action_marks_running_record_as_skipped(
    mocker,
    ...
    record = Record.objects.create(title="Concurrent record")
    ...
    assert new_job.skipped_count == 0
