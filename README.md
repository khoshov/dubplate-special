...
### YouTube
- Кнопка `Обновить треки из YouTube` на странице записи ставит одну фоновую Celery-задачу только для этой записи.
- Mass action `Обновить треки из YouTube` ставит одну фоновую задачу сразу для выбранных записей.
