# Generated by Django 5.1.7 on 2025-06-29 11:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=255, verbose_name="Record title"),
                ),
                (
                    "release_year",
                ...
                (
                    "stock",
                    models.PositiveIntegerField(
                        default=1, verbose_name="Storage on hand"
                    ),
                ),
                (
                    "condition",
                ...
                (
                    "catalog_number",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Catalog number"
                    ),
                ),
                (
                    "barcode",
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Manual price in Russian Rubles",
                        max_digits=10,
                        null=True,
                        verbose_name="Price",
                    ),
                ...
                (
                    "genres",
                    models.ManyToManyField(
                        related_name="records", to="records.genre", verbose_name="Genre"
                    ),
                ),
                (
                    "label",
                ...
                (
                    "styles",
                    models.ManyToManyField(
                        related_name="records", to="records.style", verbose_name="Style"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.PositiveIntegerField(default=1, verbose_name="Count"),
                ),
                (
                    "order",
                    models.ForeignKey(
