...
Примечание: по решению пользователя `README.md` обновляется один раз в финале, а не перед каждым промежуточным commit.
## Правило выполнения
...
- [x] Все блоки закрыты.
- [x] Все обещанные проверки выполнены.
- [x] `README.md` актуален.
- [x] История работы разбита на небольшие понятные commits.
- [x] Фича готова к дальнейшему review.
